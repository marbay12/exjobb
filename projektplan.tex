...
\chapter{Inledning}
\input{chapters/introduktion}

\section{Syfte och mål} % Goals
\input{chapters/syfte}

\section{Avgränsningar} % Constraints
\input{chapters/Begransningar}
...
\input{chapters/fyllpump} 
\newpage
\subsection{Motordriven degform}
\input{chapters/motorDrivenDegform}
\subsection{Styrenhet}
\input{chapters/mätkort}
\subsection{kommunikation med användaren}
\input{chapters/kommunikation}

\chapter{Metod}
\input{chapters/princip}
\section{Maskinens pump för fyllning}
\input{chapters/maskinenspump}
\section{Motordriven degform}
\input{chapters/motordriven_degform}
\section{Design av maskin}
\input{chapters/maskindesign}
\section{Tillverknings av maskinens delar}
\input{chapters/tillverknings_av_maskinens_delar}
\section{Sensor}
\input{chapters/sensorer}
\section{Styrenhet}
\input{chapters/styrenhet}
\section{Blockschema}
\section{Testning}

\chapter{Hittlis resultat}
\section{Maskinens design}
\input{chapters/maskinensDesign}
%\chapter{Tidsplan}
%\input{chapters/tidsplan}
\section{Prototyp}
\section{kommunikation och styrning}
\input{chapters/kommunikationochstyrning}
